...
================================================================================
 ...
 PRE-CONFIGURED FOR YOUR REAL DATA. Do not edit anything - just run it.
 It reads  trajectories_scaled.csv  (the Phase 0 scale-corrected file)
 and writes  trajectories_filtered.csv
 RUN phase0_scale_correction.py FIRST or this file will not exist.
 The ground-truth-tuned setting (KF-RTS, sigma_jerk 0.05) is already applied.
...
# CONFIG
# ==============================================================================
INPUT_PATH = r"S:\soscho\trajectories_scaled.csv"
