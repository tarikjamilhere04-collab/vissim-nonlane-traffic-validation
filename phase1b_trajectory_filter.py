...
================================================================================
 ...
 Supervisor-specified pipeline. Version 3 (self-tuning + track quality gate).
...
FORCE_METHOD     = None    # None | "KF-RTS" | "SavGol" | "sEMA"
FORCE_PARAM      = None    # sigma_jerk (KF-RTS) | window s (SavGol) | delta s (sEMA)
