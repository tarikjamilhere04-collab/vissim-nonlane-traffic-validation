...
TRUTH_CSV  = None      # e.g. r"S:\soscho\synthetic_truth.csv"
...
rule("EXPORT")
try:
    p1 = os.path.join(OUT_DIR, "phase2_pairs.csv")
    p2 = os.path.join(OUT_DIR, "phase2_lateral.csv")
    p3 = os.path.join(OUT_DIR, "phase2_report.txt")
